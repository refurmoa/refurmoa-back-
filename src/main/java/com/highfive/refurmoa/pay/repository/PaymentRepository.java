...
public interface PaymentRepository extends JpaRepository<Payment, Integer> {
    ...
    @Modifying 
    @Transactional
	@Query(value="update payment as m, product as d set m.pay_cancel = 1, d.prod_state = 2 where m.product_code = :productCode and m.pay_num = :payNum and d.product_code = :productCode", nativeQuery=true)
	void canclePay(@Param("payNum") int payNum, @Param("productCode") int productCode);
}
